...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "vtu20402@veltech.edu.in" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("vtu21040@veltech.edu.in", 'Sain9490757316.. ') # Senders mail ID and password
        server.sendmail('vtu21046@veltech.edu.in', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
